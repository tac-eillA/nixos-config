...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("qs -c scylla ipc call shell toggleQuickSettings display"))
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("wdisplays"))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("qs -c scylla ipc call shell toggleDiagnostics"))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("qs -c scylla ipc call profile togglePresentation"))
